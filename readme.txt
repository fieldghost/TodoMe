...
Slouchingly typing away in your favourite Subreddit you get the:
    Innevitable ping from the PM
    A 'lovely' text from the wife (no gender assumption. Wife is the CEO, PM, CFO and Floor Manager of the relationship)
    A fleeting ADHD neuron spark that seems slightly more stimulating than the current debate you have with Flower-Basket-95 on /r/Fedora/ about whether or not a Fedora is a way of living, or a clothing accessory that represents af way of living
...
3. For the chads - add an alias in your ~/.bashrc: alias todo="~/path/to/the/script/name_of_the_script.sh"
4. Enjoy your todo
...
todo [ add | list | done | remove | clear | remind ] [ ARGUMENT ] [ MINUTES ]
    ...
    todo list
        Lists all current todo's
            <number> <completion_indicator> <todo_name>
